 ...
 * @update 2016-01-14
 */
class DSEasyDBModel extends PDO{
	...
	public function __construct($config = array()){
		$this->db_config = array(
				'host' => DsConfig::dsConst()['DB_HOST'],
				'port' => DsConfig::dsConst()['DB_PORT'],
				'username' => DsConfig::dsConst()['DB_NAME'],
				'password' => DsConfig::dsConst()['DB_PWD'],
				'dbname' => DsConfig::dsConst()['DB_USER'],
				'charset' => DsConfig::dsConst()['DB_CHARSET']
		);
		...
		try {
            ...
            PidFile::SlogToFile(json_encode($e),false,SLICING_LOG_PATH.'error_log/','EasyDB');
			exit();
		}
	}
	...
	private function log(){
		try {
            ...
            PidFile::SlogToFile($log,false,SLICING_LOG_PATH.'sql_log/','EasyDB');
